...
public class ConstantesWebView {
    public static String VIEW_LOGIN = "views/login";
    public static String VIEW_RECOMPENSAS_HIRING = "views/hiring";
    public static String VIEW_RECOMPENSAS_INDEX = "views/index";
    public static String VIEW_RECOMPENSAS_DETALLE_MISION = "views/detalle_mision";
