...
public class LoginFailureHandler extends SimpleUrlAuthenticationFailureHandler {
    ...
    private String getMessage(AuthenticationException exception) {
        ...
        if (exception instanceof BadCredentialsException) {
            keyMsgError = ConstantesWebMessage.MSG_EXCEPTION_SECURITY_ERROR_CREDENCIALES_INCORRECTAS;
        } else if (exception instanceof DisabledException) {
            keyMsgError = ConstantesWebMessage.MSG_EXCEPTION_SECURITY_ERROR_USUARIO_DESABILITADO;
        } else if (exception instanceof AccountExpiredException) {
            keyMsgError = ConstantesWebMessage.MSG_EXCEPTION_SECURITY_ERROR_USUARIO_EXPIRADO;
        } else if (exception instanceof CredentialsExpiredException) {
            keyMsgError = ConstantesWebMessage.MSG_EXCEPTION_SECURITY_ERROR_CREDENCIALES_EXPIRADAS;
        } else if (exception instanceof LockedException) {
            keyMsgError = ConstantesWebMessage.MSG_EXCEPTION_SECURITY_ERROR_USUARIO_BLOQUEADO;
        }
