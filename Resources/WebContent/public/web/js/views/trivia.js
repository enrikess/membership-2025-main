...
Mundial.prototype.obtenerTrivia = function () {
    ...
    Promotick.ajax.get({
        url : obj.uri + 'trivia/obtenerTrivia',
        messageError : false,
        before : function() {},
        success : function(response) {
            ...
            try {
                debugger;
                if (response.data.estadoTriviaParticipante !== "PEN") {
...
Mundial.prototype.mostrarTriviaActiva = function (obj, data) {
    obj.respuestas = [];
    obj.preguntas = data.data.result[0];
...
Mundial.prototype.obtenerRanking = function () {
    ...
    Promotick.render.get({
        url : obj.uri + 'trivia/obtenerRanking',
...
Mundial.prototype.matchActivo = function (partidosDiaActivo) {
    ...
    Promotick.render.post({
        url : obj.uri + 'trivia/matchActivo',
...
Mundial.prototype.obtenerPronostico = function (callback) {
    ...
    Promotick.ajax.get({
        url : obj.uri + 'trivia/obtenerPronostico',
        messageError : false,
        before : function() {},
        success : function(response) {
            if (response.status) {
...
Mundial.prototype.guardarPronostico = function () {
    ...
    $.ajax({
        url: obj.uri + "trivia/registrarPronosticoParticipante",
        type: "post",
...
Mundial.prototype.insertarPartidosPronosticos = function (fechas, data) {
    ...
    Promotick.render.post({
        url : obj.uri + 'trivia/partidosPronosticos',
...
Mundial.prototype.eventGuardarPolla = function (obj, cambiarPag) {
    function registrarPolla() {
        ...
        $.ajax({
            url: obj.uri + "trivia/registrarPollaParticipante",
            type: "post",
