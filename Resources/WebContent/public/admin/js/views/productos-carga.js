...
ProductosCarga.prototype.init = function() {
    this.handle();
};

ProductosCarga.prototype.handle = function() {
    var obj = this;

    obj.inputFile.fileinput({
        theme: 'fa',
        language: 'es',
        uploadUrl: obj.uri + "catalogos/importar-producto/subir-excel",
        ...
        if (data.response.status) {
            ...
            Promotick.toast.error(data.response.message, 'Carga de productos');
        }
...
ProductosCarga.prototype.mostrarResumen = function(response) {
    var obj = this;
    ...
    if (!obj.resumen) {
        ...
        Promotick.render.post({
            url: obj.uri + 'catalogos/importar-producto/viewResumenCargaProductos',
