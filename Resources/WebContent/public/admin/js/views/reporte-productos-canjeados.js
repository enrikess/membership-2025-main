function ReporteProductosCanjeados(uri) {
    this.uri = uri;
    this.rangoDatePicker = $('#rangoDatePicker');
    this.grid = $('#gridProductosCanjeados');
...
ReporteProductosCanjeados.prototype.init = function() {
    this.handle();
    this.listarProductosCanjeados();
};

ReporteProductosCanjeados.prototype.handle = function() {
    var obj = this;
...
ReporteProductosCanjeados.prototype.listarProductosCanjeados = function(){
    var obj = this;
    obj.grid.DataTable({
        "bProcessing" : true,
        "bFilter" : false,
        ...
        "bSort": false,
        "ajax": {
            "url" : obj.uri + 'reportes/productos-canjeados/listar-prod-canjeados',
            "type": "POST",
            "data" : function(d) {
...
ReporteProductosCanjeados.prototype.gridReload = function(){
