...
DireccionesCarga.prototype.init = function() {
    this.handle();
};

DireccionesCarga.prototype.handle = function() {
    var obj = this;

    obj.inputFile.fileinput({
        theme: 'fa',
        language: 'es',
        uploadUrl: obj.uri + "direcciones/importar/subir-excel",
        ...
        if (data.response) {
            ...
            Promotick.toast.error(data.response.message, 'Carga de direcciones');
        }
...
DireccionesCarga.prototype.mostrarResumen = function(response) {
    var obj = this;
    ...
    if (!obj.resumen) {
        ...
        Promotick.render.post({
            url : obj.uri + 'direcciones/importar/viewResumenCargaDireccion',
