...
ParticipantesCargaEstado.prototype.handle = function() {
    ...
    obj.inputFile.fileinput({
        theme: 'fa',
        language: 'es',
        uploadUrl: obj.uri + "participantes/importar/subir-excel/estado",
        ...
        if (data.response) {
            ...
            Promotick.toast.error(data.response.message, 'Carga de estados participantes');
        }
...
ParticipantesCargaEstado.prototype.mostrarResumen = function(response) {
    ...
    if (!obj.resumen) {
        ...
        Promotick.render.post({
            url : obj.uri + 'participantes/importar/viewResumenCargaParticipanteEstado',
