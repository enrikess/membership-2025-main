var uriGeneral;
var urlImagenPopup = "";
function PopupWeb(uri, uriImagenes) {
    this.uri = uri;
    uriGeneral = uri;
...
PopupWeb.prototype.init = function() {
    this.handle();
    this.listarSegmentosPopup();
};

PopupWeb.prototype.handle = function() {
    var obj = this;
    ...
    $(document).on('click', '.onoffswitch', function(e) {
        ...
        swal({
            ...
            text: 'Estas seguro de ' + estado + ' este popup ? ',
            type: "warning",
...
PopupWeb.prototype.actualizarEstado = function(idCatalogo, checked, $checkbox) {
    var obj = this;
    ...
    Promotick.ajax.post({
        url : obj.uri + 'administracion/popups-web/actualizar-estado',
...
PopupWeb.prototype.listarSegmentosPopup = function(){
    var obj = this;
    obj.grid.DataTable({
        "bProcessing" : true,
        "bFilter" : false,
        ...
        "bSort": false,
        "ajax": {
            "url" : obj.uri + 'administracion/popups-web/listar/' + obj.slcOrden.val(),
            "type": "GET",
            "data" : function(d) {
        ...
        "columns" : [
            ...
            {"data" : "popupInicio", "orderable": false, "sClass" : "text-center", "render" : this._formatImagen},
            {"data" : "popup", "orderable": false,"class":"estado", "render" : obj._formatEstadoSwitch}
        ],
...
PopupWeb.prototype._formatNombre = function(data, type, full) {
    var obj = this;
    return '<a href="' + uriGeneral + 'administracion/popups-web/editar/' + full.idCatalogo + '"><u>' + data + '</u></a>';
};

PopupWeb.prototype._formatImagen = function(data, type, full) {
    var obj = this;
    if (data != null && data != '') {
...
PopupWeb.prototype._formatEstadoSwitch = function(data, type, full) {
    var estado = '';
    var checked= '';
...
PopupWeb.prototype.gridReload = function(){
