function ParticipantesCarga(uri) {
    this.uri = uri;
...
ParticipantesCarga.prototype.init = function() {
    this.handle();
};

ParticipantesCarga.prototype.handle = function() {
    var obj = this;

    obj.inputFile.fileinput({
        theme: 'fa',
        language: 'es',
        uploadUrl: obj.uri + "participantes/importar/subir-excel",
        ...
        if (data.response) {
            ...
            Promotick.toast.error(data.response.message, 'Carga de participantes');
        }
...
ParticipantesCarga.prototype.mostrarResumen = function(response) {
    var obj = this;
    ...
    if (!obj.resumen) {
        ...
        Promotick.render.post({
            url : obj.uri + 'participantes/importar/viewResumenCargaParticipante',
