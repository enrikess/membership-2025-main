...
public interface ReporteAdminService {
    ...
    List<ParticipanteTransaccion> listarPuntos(FiltroParticipanteTransaccion filtroParticipanteTransaccion);

    Integer contarPuntos(FiltroParticipanteTransaccion filtroParticipanteTransaccion);
