...
public class ReporteVentas implements Serializable {
    ...
    public static ReporteVentas getFromEntity(Factura factura) {
        if (factura == null) {
            return null;
        }
        ...
        return new ReporteVentas()
                ...
                .setMonto(String.valueOf(factura.getMontoFactura()))
                .setPuntosPosibles(factura.getPuntosPosibles())
                .setPuntosRestados(factura.getPuntosRestados());

    }

    public static List<ReporteVentas> getFromEntities(List<Factura> facturas) {
        List<ReporteVentas> list = new ArrayList<>();
